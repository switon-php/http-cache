 ...
 * Cache lookup happens on RequestReady; cache persistence happens on HeadersSending.
 *
 * Road-signs:
...
class PageCacheFilter implements ContextAware
{
    ...
    /**
     * Return request-local page-cache state for the current request.
     */
    ...
    /**
     * Resolve the page-cache attribute for one controller method.
     */
    ...
    /**
     * Format a strong ETag from cached content.
     */
    ...
    /**
     * Normalize ETag values for weak/quoted comparison.
     */
    ...
    /**
     * Check whether If-None-Match contains the resolved ETag.
     */
    ...
    /**
     * Serve a cached response or 304 before the controller action runs.
     */
    ...
    /**
     * Persist a successful response into Redis and finalize cache headers.
     *
