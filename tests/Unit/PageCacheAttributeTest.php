...
class PageCacheAttributeTest extends TestCase
{
    ...
    public function testAllowsZeroTtlForNoStoreLikeBehavior(): void
    {
        $attribute = new PageCache(0, ['id']);

        $this->assertSame(0, $attribute->ttl);
        $this->assertSame(['id'], $attribute->key);
    }
}
